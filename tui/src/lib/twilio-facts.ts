export const TWILIO_AI_FACTS = [
  ...
  "Ask Twilio runs locally; the model uses a Twilio-aware prompt built from the toolkit's Skills index.",
  ...
  "Ask Twilio uses the Fast response style by default; choose Thoughtful under Settings when you want more deliberate replies.",
